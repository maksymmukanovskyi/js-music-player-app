...
import {currentlyDragged, previewPlayerElements, state} from '../index';


// const previewNodes = previewPlayerElements(state.previewTriggered);
...
//           </div>
//         </div>
//         <span class="current-title">Preview of: ${e.target.dataset.title}</span>
